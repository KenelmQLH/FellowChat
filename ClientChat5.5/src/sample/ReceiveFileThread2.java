...
public class ReceiveFileThread2 extends Thread {
    ...
    public ReceiveFileThread2(TextArea textArea, Stage stage, String ip, int port_number, String file_name, long file_size, String other_nickname, boolean permit, File selectedDirectory) {
